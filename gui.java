...
public class gui extends JFrame {
    ...
    public void interfejs(){
        ...
        pole_tekstowe1.getDocument().addDocumentListener(new DocumentListener() {
            @Override
            public void insertUpdate(DocumentEvent e) {
                usun_liczbe(dane_do_wykresu[1]);
                if(Arrays.asList(dane_do_wykresu).contains(pole_tekstowe1.getText())){
                    JOptionPane.showMessageDialog(null,"Dane nie mogą się powtarzać","Błąd",JOptionPane.WARNING_MESSAGE);
                    return;
                }
            ...
            public void removeUpdate(DocumentEvent e) {
                usun_liczbe(dane_do_wykresu[1]);
                if(Arrays.asList(dane_do_wykresu).contains(pole_tekstowe1.getText())){
                    JOptionPane.showMessageDialog(null,"Pole na Dane nie może być puste","Błąd",JOptionPane.WARNING_MESSAGE);
                    return;
                }
        ...
        pole_tekstowe2.getDocument().addDocumentListener(new DocumentListener() {
            @Override
            public void insertUpdate(DocumentEvent e) {
                usun_liczbe(dane_do_wykresu[2]);
                if(Arrays.asList(dane_do_wykresu).contains(pole_tekstowe2.getText())){
                    JOptionPane.showMessageDialog(null,"Dane nie mogą się powtarzać","Błąd",JOptionPane.WARNING_MESSAGE);
                    return;
                }
        ...
        pole_tekstowe3.getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void insertUpdate(DocumentEvent e) {
                ...
                if(Arrays.asList(dane_do_wykresu).contains(pole_tekstowe3.getText())){
                    JOptionPane.showMessageDialog(null,"Dane nie mogą się powtarzać","Błąd",JOptionPane.WARNING_MESSAGE);
                    return;
                }
        ...
        pole_tekstowe4.getDocument().addDocumentListener(new DocumentListener() {
            @Override
            public void insertUpdate(DocumentEvent e) {
                usun_liczbe(dane_do_wykresu[4]);
                if(Arrays.asList(dane_do_wykresu).contains(pole_tekstowe4.getText())){
                    JOptionPane.showMessageDialog(null,"Dane nie mogą się powtarzać","Błąd",JOptionPane.WARNING_MESSAGE);
                    return;
                }
        ...
        pole_tekstowe5.getDocument().addDocumentListener(new DocumentListener() {
            @Override
            public void insertUpdate(DocumentEvent e) {
                usun_liczbe(dane_do_wykresu[5]);
                if(Arrays.asList(dane_do_wykresu).contains(pole_tekstowe5.getText())){
                    JOptionPane.showMessageDialog(null,"Dane nie mogą się powtarzać","Błąd",JOptionPane.WARNING_MESSAGE);
                    return;
                }
        ...
        pole_tekstowe6.getDocument().addDocumentListener(new DocumentListener() {
            @Override
            public void insertUpdate(DocumentEvent e) {
                usun_liczbe(dane_do_wykresu[6]);
                if(Arrays.asList(dane_do_wykresu).contains(pole_tekstowe6.getText())){
                    JOptionPane.showMessageDialog(null,"Dane nie mogą się powtarzać","Błąd",JOptionPane.WARNING_MESSAGE);
                    return;
                }
        ...
        pole_tekstowe7.getDocument().addDocumentListener(new DocumentListener() {
            @Override
            public void insertUpdate(DocumentEvent e) {
                usun_liczbe(dane_do_wykresu[7]);
                if(Arrays.asList(dane_do_wykresu).contains(pole_tekstowe7.getText())){
                    JOptionPane.showMessageDialog(null,"Dane nie mogą się powtarzać","Błąd",JOptionPane.WARNING_MESSAGE);
                    return;
                }
        ...
        pole_tekstowe8.getDocument().addDocumentListener(new DocumentListener() {
            @Override
            public void insertUpdate(DocumentEvent e) {
                usun_liczbe(dane_do_wykresu[8]);
                if(Arrays.asList(dane_do_wykresu).contains(pole_tekstowe8.getText())){
                    JOptionPane.showMessageDialog(null,"Dane nie mogą się powtarzać","Błąd",JOptionPane.WARNING_MESSAGE);
                    return;
                }
        ...
        pole_tekstowe9.getDocument().addDocumentListener(new DocumentListener() {
            @Override
            public void insertUpdate(DocumentEvent e) {
                usun_liczbe(dane_do_wykresu[9]);
                if(Arrays.asList(dane_do_wykresu).contains(pole_tekstowe9.getText())){
                    JOptionPane.showMessageDialog(null,"Dane nie mogą się powtarzać","Błąd",JOptionPane.WARNING_MESSAGE);
                    return;
                }
        ...
        pole_tekstowe10.getDocument().addDocumentListener(new DocumentListener() {
            @Override
            public void insertUpdate(DocumentEvent e) {
                usun_liczbe(dane_do_wykresu[10]);
                if(Arrays.asList(dane_do_wykresu).contains(pole_tekstowe10.getText())){
                    JOptionPane.showMessageDialog(null,"Dane nie mogą się powtarzać","Błąd",JOptionPane.WARNING_MESSAGE);
                    return;
                }
        ...
        wybierz_guzik.addActionListener(e -> {
            ...
            thread = new Thread(() -> {
                ...
                frame1 = new SwingWrapper(chart).displayChart();
                SwingUtilities.invokeLater(() -> frame1.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE));
            });
            thread.start();
        });
